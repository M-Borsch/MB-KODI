# Order Favourites - Insert (plugin.program.orderfavourites.insert)
![icon](https://github.com/M-Borsch/plugin.program.orderfavourites.insert/blob/master/icon.png)  
...
### Install it [from the zips in the Releases page](https://github.com/M-Borsch/plugin.program.orderfavourites.insert/releases).
